...
# -*- coding: utf-8 -*-
#
# gravure documentation build configuration file, created by
...
project = 'PyGutenprint'
copyright = '2014, Atelier Obscur'
...
modindex_common_prefix = ['gravure.pygutenprint.']
...
man_pages = [
    ('index', 'gravure', 'gravure Documentation',
     ['Author'], 1)
]
...
texinfo_documents = [
  ('index', 'gravure', 'gravure Documentation',
   'Author', 'gravure', 'One line description of project.',
   'Miscellaneous'),
]
